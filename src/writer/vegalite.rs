...
mod tests {
    ...
    fn test_missing_column_error() {
        ...
        let layer = Layer::new(Geom::Point)
            .with_aesthetic("x".to_string(), AestheticValue::standard_column("x".to_string()))
            .with_aesthetic("y".to_string(), AestheticValue::standard_column("foo".to_string()));
        spec.layers.push(layer);
    ...
    fn test_time_series_to_iso_format() {
        ...
        let mut spec = VizSpec::new();
        let layer = Layer::new(Geom::Point)
            .with_aesthetic("x".to_string(), AestheticValue::standard_column("time".to_string()))
            .with_aesthetic("y".to_string(), AestheticValue::standard_column("value".to_string()));
        spec.layers.push(layer);
    ...
    fn test_path_geom_has_order_encoding_and_transform() {
        ...
        layer
            .mappings
            .insert("x".to_string(), AestheticValue::standard_column("lon".to_string()));
        layer
            .mappings
            .insert("y".to_string(), AestheticValue::standard_column("lat".to_string()));
        spec.layers.push(layer);
    ...
    fn test_line_geom_no_order_encoding() {
        ...
        layer
            .mappings
            .insert("x".to_string(), AestheticValue::standard_column("date".to_string()));
        layer
            .mappings
            .insert("y".to_string(), AestheticValue::standard_column("value".to_string()));
        spec.layers.push(layer);
