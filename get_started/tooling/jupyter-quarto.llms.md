...
First, install ggsql on your system using the Jupyter kernel [installation instructions](../installation.llms.md). If you do not already have Jupyter installed, you should install it in a new virtual environment using [uv](https://docs.astral.sh/uv/) or `pip` first:
...
[![](./screenshots/quarto-document.png)](./screenshots/quarto-document.png)
...
[![](./screenshots/jupyter-notebook.png)](./screenshots/jupyter-notebook.png)
