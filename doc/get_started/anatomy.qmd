...
## Aesthetics
You will encounter aesthetics throughout the documentation and it is arguably one of the most important concepts to get right. Aesthetics are the visual characteristics that entities take on to make up a layer, e.g. the [color](../syntax/scale/aesthetic/1_color.qmd) of a point, the [linewidth](../syntax/scale/aesthetic/linewidth.qmd) of a line, and the [opacity](../syntax/scale/aesthetic/2_opacity.qmd) of a polygon.
