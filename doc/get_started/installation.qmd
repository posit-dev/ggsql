...
[uv](https://docs.astral.sh/uv/) is the fastest way to install Rust binaries:
...
For syntax highlighting and language support in VS Code or Positron, install the ggsql extension. You can either install it directly from the VS Code marketplace from the IDE or install it manually:
