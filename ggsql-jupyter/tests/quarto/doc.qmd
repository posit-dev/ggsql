...
GROUP BY category
VISUALISE AS PLOT
DRAW bar USING x = category, y = total, fill = category
...
VISUALISE AS PLOT
DRAW line USING x = date, y = value, color = 'blue'
DRAW point USING x = date, y = value, color = 'red', size = 30
SCALE x USING type = 'date'
...
VISUALISE AS PLOT
DRAW line USING x = month, y = total_revenue, color = 'steelblue'
DRAW point USING x = month, y = total_revenue, color = 'darkblue', size = 30
DRAW line USING x = month, y = total_quantity_scaled, color = 'coral'
DRAW point USING x = month, y = total_quantity_scaled, color = 'orangered', size = 30
SCALE x USING type = 'date'
...
SELECT x, y FROM 'data.csv'
VISUALISE AS PLOT
DRAW point USING x = x, y = y, color = 'blue', size = 4
...
GROUP BY category
VISUALISE AS PLOT
DRAW bar USING y = total, fill = category
COORD polar
...
DRAW point USING x = month, y = total_revenue
SCALE x USING type = 'date'
...
VISUALISE AS PLOT
DRAW bar USING x = category, y = total_revenue, fill = region
