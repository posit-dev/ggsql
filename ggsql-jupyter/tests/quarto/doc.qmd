...
GROUP BY category
VISUALISE AS PLOT
DRAW bar MAPPING category AS x, total AS y, category AS fill
...
VISUALISE AS PLOT
DRAW line MAPPING date AS x, value AS y, 'blue' AS color
DRAW point MAPPING date AS x, value AS y, 'red' AS color SETTING size TO 30
SCALE x USING type = 'date'
...
VISUALISE AS PLOT
DRAW line MAPPING month AS x, total_revenue AS y, 'steelblue' AS color
DRAW point MAPPING month AS x, total_revenue AS y, 'darkblue' AS color SETTING size TO 30
DRAW line MAPPING month AS x, total_quantity_scaled AS y, 'coral' AS color
DRAW point MAPPING month AS x, total_quantity_scaled AS y, 'orangered' AS color SETTING size TO 30
SCALE x USING type = 'date'
...
SELECT x, y FROM 'data.csv'
VISUALISE AS PLOT
DRAW point MAPPING x AS x, y AS y, 'blue' AS color SETTING size TO 4
COORD cartesian USING xlim = [0, 60], ylim = [0, 70]
...
GROUP BY category
VISUALISE AS PLOT
DRAW bar MAPPING total AS y, category AS fill
COORD polar
...
DRAW point MAPPING month AS x, total_revenue AS y
SCALE x USING type = 'date'
...
VISUALISE AS PLOT
DRAW bar MAPPING category AS x, total_revenue AS y, region AS fill
