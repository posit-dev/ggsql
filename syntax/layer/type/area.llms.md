...
The area layer is used to display absolute amounts over a sorted x-axis. It can be seen as a [ribbon layer](../../../syntax/layer/type/ribbon.llms.md) where the `ymin` is anchored at zero.
