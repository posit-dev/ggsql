...
\\ y(x) = \frac{\sum\_{i=1}^nW(x)y_i}{\sum\_{i=1}^nW(x)} \\
...
Please note the similarity of \\W(x)\\ to the [kernel density estimation formula](../../../syntax/layer/type/density.llms.md#data-transformation).
