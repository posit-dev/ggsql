...
The spatial layer is used to render geographic geometries consisting of polygons, lines and points used to make maps like choropleths. It differs from other layers in that it uses a special [simple features](https://en.wikipedia.org/wiki/Simple_Features) geometry column that defines the shapes.
